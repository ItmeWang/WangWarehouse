package com.administrator.day01.adapter;
...
public class BabyAdapter extends RecyclerView.Adapter<BabyAdapter.ViewHolder> {
    ...
    public BabyAdapter(Context context, List<StoryBean.ResultsBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.baby_item, null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mTv3.setText(resultsBean.getDesc());
    }
